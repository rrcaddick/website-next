...
const galleryImages = [
  {
    src: "/images/accommodation/family-room/gallery/thumb/1.webp",
    alt: "Family Room Overview",
    fullSize: "/images/accommodation/family-room/gallery/full/1.webp",
  },
  {
    src: "/images/accommodation/family-room/gallery/thumb/2.webp",
    alt: "Family Room Interior",
    fullSize: "/images/accommodation/family-room/gallery/full/2.webp",
  },
  {
    src: "/images/accommodation/family-room/gallery/thumb/3.webp",
    alt: "Family Room Beds",
    fullSize: "/images/accommodation/family-room/gallery/full/3.webp",
  },
  {
    src: "/images/accommodation/family-room/gallery/thumb/4.webp",
    alt: "Family Room View",
    fullSize: "/images/accommodation/family-room/gallery/full/4.webp",
  },
  {
    src: "/images/accommodation/family-room/gallery/thumb/5.webp",
    alt: "Family Room Additional View 1",
    fullSize: "/images/accommodation/family-room/gallery/full/5.webp",
  },
  {
    src: "/images/accommodation/family-room/gallery/thumb/6.webp",
    alt: "Family Room Additional View 2",
    fullSize: "/images/accommodation/family-room/gallery/full/6.webp",
  },
  {
    src: "/images/accommodation/family-room/gallery/thumb/7.webp",
    alt: "Family Room Additional View 3",
    fullSize: "/images/accommodation/family-room/gallery/full/7.webp",
  },
  {
    src: "/images/accommodation/family-room/gallery/thumb/8.webp",
    alt: "Family Room Additional View 4",
    fullSize: "/images/accommodation/family-room/gallery/full/8.webp",
  },
];
...
export default function FamilyRoomPage() {
  return (
    <div className="min-h-screen">
      <PageHero
        mobileSrc="/images/accommodation/family-room/hero/mobile.webp"
        desktopSrc="/images/accommodation/family-room/hero/desktop.webp"
        title="Family Room"
      />
      {/* Content Section */}
      <div className="pt-2 pb-8 sm:pt-4 sm:pb-12 px-4">
        <div className="max-w-7xl mx-auto px-4">
          <p className="text-xs md:text-base text-gray-600 max-w-3xl mx-auto text-center">
            Our family rooms provide a delightful retreat, tailored for families or small groups seeking both comfort
            and privacy.
          </p>
