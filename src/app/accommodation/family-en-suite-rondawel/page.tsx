...
const galleryImages = [
  {
    src: "/images/accommodation/family-en-suite-rondawel/gallery/thumb/1.webp",
    alt: "Family En-suite Rondawel Overview",
    fullSize: "/images/accommodation/family-en-suite-rondawel/gallery/full/1.webp",
  },
  {
    src: "/images/accommodation/family-en-suite-rondawel/gallery/thumb/2.webp",
    alt: "Family En-suite Rondawel Interior",
    fullSize: "/images/accommodation/family-en-suite-rondawel/gallery/full/2.webp",
  },
  {
    src: "/images/accommodation/family-en-suite-rondawel/gallery/thumb/3.webp",
    alt: "Family En-suite Rondawel Bathroom",
    fullSize: "/images/accommodation/family-en-suite-rondawel/gallery/full/3.webp",
  },
  {
    src: "/images/accommodation/family-en-suite-rondawel/gallery/thumb/4.webp",
    alt: "Family En-suite Rondawel View",
    fullSize: "/images/accommodation/family-en-suite-rondawel/gallery/full/4.webp",
  },
  {
    src: "/images/accommodation/family-en-suite-rondawel/gallery/thumb/5.webp",
    alt: "Family En-suite Rondawel Additional View 1",
    fullSize: "/images/accommodation/family-en-suite-rondawel/gallery/full/5.webp",
  },
  {
    src: "/images/accommodation/family-en-suite-rondawel/gallery/thumb/6.webp",
    alt: "Family En-suite Rondawel Additional View 2",
    fullSize: "/images/accommodation/family-en-suite-rondawel/gallery/full/6.webp",
  },
  {
    src: "/images/accommodation/family-en-suite-rondawel/gallery/thumb/7.webp",
    alt: "Family En-suite Rondawel Additional View 3",
    fullSize: "/images/accommodation/family-en-suite-rondawel/gallery/full/7.webp",
  },
  {
    src: "/images/accommodation/family-en-suite-rondawel/gallery/thumb/8.webp",
    alt: "Family En-suite Rondawel Additional View 4",
    fullSize: "/images/accommodation/family-en-suite-rondawel/gallery/full/8.webp",
  },
];
...
export default function FamilyEnSuiteRondawelPage() {
  return (
    <div className="min-h-screen">
      <PageHero
        mobileSrc="/images/accommodation/family-en-suite-rondawel/hero/mobile.webp"
        desktopSrc="/images/accommodation/family-en-suite-rondawel/hero/desktop.webp"
      ...
      <div className="pt-2 pb-8 sm:pt-4 sm:pb-12 px-4">
        <div className="max-w-7xl mx-auto px-4">
          <p className="text-xs md:text-base text-gray-600 max-w-3xl mx-auto text-center">
            The forest's very own penthouse suite - A luxurious traditional African-style round house with modern
            amenities. Perfect for families seeking a private and authentic experience with all the comforts of home.
          </p>
