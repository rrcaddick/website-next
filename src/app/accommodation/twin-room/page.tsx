...
const galleryImages = [
  {
    src: "/images/accommodation/twin-room/gallery/thumb/1.webp",
    alt: "Twin Room Overview",
    fullSize: "/images/accommodation/twin-room/gallery/full/1.webp",
  },
  {
    src: "/images/accommodation/twin-room/gallery/thumb/2.webp",
    alt: "Twin Room Interior",
    fullSize: "/images/accommodation/twin-room/gallery/full/2.webp",
  },
  {
    src: "/images/accommodation/twin-room/gallery/thumb/3.webp",
    alt: "Twin Room Beds",
    fullSize: "/images/accommodation/twin-room/gallery/full/3.webp",
  },
  {
    src: "/images/accommodation/twin-room/gallery/thumb/4.webp",
    alt: "Twin Room View",
    fullSize: "/images/accommodation/twin-room/gallery/full/4.webp",
  },
  {
    src: "/images/accommodation/twin-room/gallery/thumb/5.webp",
    alt: "Twin Room Additional View 1",
    fullSize: "/images/accommodation/twin-room/gallery/full/5.webp",
  },
  {
    src: "/images/accommodation/twin-room/gallery/thumb/6.webp",
    alt: "Twin Room Additional View 2",
    fullSize: "/images/accommodation/twin-room/gallery/full/6.webp",
  },
  {
    src: "/images/accommodation/twin-room/gallery/thumb/7.webp",
    alt: "Twin Room Additional View 3",
    fullSize: "/images/accommodation/twin-room/gallery/full/7.webp",
  },
  {
    src: "/images/accommodation/twin-room/gallery/thumb/8.webp",
    alt: "Twin Room Additional View 4",
    fullSize: "/images/accommodation/twin-room/gallery/full/8.webp",
  },
];
...
export default function TwinRoomPage() {
  return (
    <div className="min-h-screen">
      <PageHero
        mobileSrc="/images/accommodation/twin-room/hero/mobile.webp"
        desktopSrc="/images/accommodation/twin-room/hero/desktop.webp"
        title="Twin Room"
      />
      {/* Content Section */}
      <div className="pt-2 pb-8 sm:pt-4 sm:pb-12 px-4">
        <div className="max-w-7xl mx-auto px-4">
          <p className="text-xs md:text-base text-gray-600 max-w-3xl mx-auto text-center">
            Perfect for friends or solo travelers, our twin room offers two comfortable single beds in a cozy space. A
            great balance of privacy and social atmosphere.
          </p>
