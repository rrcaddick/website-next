  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="relative w-full aspect-[9/5] mb-6 bg-gray-900 block md:hidden">
        <Image
          src="/images/home/mobile/half-collared-kingfisher-trail-banner.webp"
          alt="Fairy Knowe Half Collared Kingfisher Trail Mobile Banner"
          fill
      ...
      <div className="relative h-[300px] lg:h-[500px] w-full mb-6 bg-gray-900 hidden md:block">
        <Image
          ...
          alt="Fairy Knowe Half Collared Kingfisher Trail"
          fill
          className="object-cover"
          priority
          quality={85}
